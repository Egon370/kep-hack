...
BrunoData:
	db $FF, 54, JABETTA, 55, STEELIX, 54, TRICULES, 56, HITMONCHAN, 56, HITMONLEE, 58, MACHAMP, 0
; post-game rematch team (currently unused)
	db $FF, 75, JABETTA, 76, STEELIX, 75, SIRFETCHD, 76, TRICULES, 76, HITMONTOP, 78, MACHAMP, 0

AgathaData:
	db $FF, 55, ANNIHILAPE, 56, CROBAT, 55, GENGAR, 56, DECADYBUG, 56, UMBREON, 58, GENGAR, 0		; Agatha has double Gengars in every single battle in the main-series, it's fine here...
; post-game rematch team (currently unused)
	db $FF, 77, ANNIHILAPE, 78, CROBAT, 77, MAROWAK_A, 78, DECADYBUG, 78, UMBREON, 80, GENGAR, 0
